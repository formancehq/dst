...
deploy-local:
  ...
  LEDGER_LATEST_TAG=$LEDGER_LATEST_TAG just workload/build 'false'
  minikube image load us-central1-docker.pkg.dev/molten-verve-216720/formance-repository/workload:daily_nofaults

  LEDGER_PREVIOUS_TAG=$LEDGER_PREVIOUS_TAG just config/build-manifest "$tmpdir/resources.yaml" 'daily_nofaults'
