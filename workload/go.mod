module github.com/formancehq/dst/workload
...
require (
	...
	golang.org/x/sync v0.18.0 // indirect; indirect, for singleflight package
)
...
require (
	...
	github.com/formancehq/ledger v0.0.0-20260219133304-d17d2258f68d
